...
A live voice + text AI companion. Talk to Noa naturally over the Gemini Live
...
## Setup
1. Open `AirC.html` in a browser (served over http(s), not `file://`, so
...
## Architecture
- `AirC.html` — UI + orchestration only.
