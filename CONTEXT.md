...
- Teacher persona prompt (`persona/personas.js`) has a ROAST STYLE block: quick, specific, affectionate roasts, callbacks to real things, no sensitive targets, stops if user is low.
